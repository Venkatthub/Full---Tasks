package collections.linkedlist.imple;

public class LinkList<T> {

	/*
	 * Linked list with all methods insert(T data) set(int index, T num) size()
	 * showFirst() showLast() show() removeFirst() removeLast() removeElement()
	 */
